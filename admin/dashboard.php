...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-2">
        <div class="row">
            ...
            $name = $_SESSION['sub_admin_name'];
            $t = $_SESSION['admin_type'];

            ?>
            <div class="ms-3">
                <h3 class="mb-3 h4 font-weight-bolder">
                    Hello <span class="text-primary"><?= $name ?></span>
                    , Your current role is <span class="text-success"><?= $t ?></span>
                </h3>
            ...
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card">
                    ...
                    <div class="card-footer p-2 ps-3">
                        <!--<p class="mb-0 text-sm"><span class="text-success font-weight-bolder">+5% </span>than last week</p>-->
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                ...
                $sql = "SELECT COUNT(email) AS total_users FROM user_data";
                $result = $conn->query($sql);

                // Check if there are results and display total users
                if ($result->num_rows > 0) {
                    $row = $result->fetch_assoc();
                    // echo "Total users registered: " . $row["total_users"];
                    $a = $row["total_users"];
                } else {
                    echo "No users found.";
                }
