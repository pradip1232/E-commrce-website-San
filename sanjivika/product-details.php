...
<div class="container  products-details-page">
    <div class="row">
        ...
        <div class="col-md-6">
            <!-- Heading -->
            <h3 class="turmeric-heading-1">Turmeric (Haldi) Power 100g</h3>
            <!-- Four Yellow Stars -->
            <div class="row">
                <div class="col">
            ...
            <div class="row mt-3">
                <div class="col">
                    ...
                    <button class="btn-button-two ">200gm</button>
                </div>
            </div>
            <!-- Heading 2 -->
            <p class="mrp-all-taxes mt-3">MRS (includes all taxes)</p>
            ...
            <div>
                ...
                <div class="row mt-2">
                    <div class="col-10 text-startgreen-heart  d-flex ">
                        <button class="btn-buy-now-top" onclick="window.location.href='checkout'">BUY NOW</button>
    ...
    <div class="container-fluid mt-5 pt-5">
        <div class="row top-spaces-for-navigation-nav p-0">
            <div class="col-12 p-0">
                <div class="card card-primary card-tabs card-size">
                    <div>
...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .powder-second-slider-below-heading {
            margin-top: 10px; /* add margin to separate headings */
        }
