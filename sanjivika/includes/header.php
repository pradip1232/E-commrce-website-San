...
<head>
    ...
    <style>
        ...
        .products-details-page ,.wishlist-container-page{
            margin-top: 155px;
        }
        ...
        <div class="row no-gutters w-100 fixed-top floter-header">
            <div class="col-2 d-flex align-items-center logo-container">
                <a class="navbar-brand" href="/">
                    <img src="assets/images/LOGO Support Useful links About Us Career Become An Instructor Become An Affiliate Lorem Ipsum is simply dummy text of the printing and typesetting industry 2.png" alt="Logo" class="header-logo">
                </a>
            </div>
            <div class="col-10 navlink-container-r-search">
                <nav class="navbar navbar-expand navbar-custom navbar-light py-1 mt-4">
                        ...
                        <ul class="navbar-nav ml-auto navbar-expand-lg navbar-light">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center" href="#" data-toggle="modal" data-target="#cartModal">
                                    <span class="shopping-cart-top-display">Shopping Cart</span>
