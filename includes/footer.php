		...
		<div class="container-fluid px-5">
			<div class="row">
				...
				<div class="col-md-2">
					...
					<ul class="list-unstyled text-left text-center-mobile">
						<li><a href="signup" class="text-dark text-decoration-none">Sign In</a></li>
...
<script>
	...
	function getTotalProductCount() {
		// Retrieve cart data from localStorage (assuming it's saved as 'shoppingCart')
		const cart = JSON.parse(localStorage.getItem("shoppingCart")) || [];

		// Calculate the total count by summing up the quantities
		const totalCount = cart.reduce((total, product) => total + product.quantity, 0);

		// Display the total count on the webpage (assuming there's an element with id 'totalProductCount')
